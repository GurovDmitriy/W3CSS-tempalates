...
let leftBtn = document.querySelector('.usr-left-btn');
let rightBtn = document.querySelector('.usr-right-btn');
let indicators = document.querySelectorAll('.usr-indicator');
